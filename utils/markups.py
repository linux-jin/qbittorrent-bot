...
def get_overview_altspeed_markup():
    ...
    keyboard = [speeds_row, [
        InlineKeyboardButton('启用', callback_data='overview:alton'),
        InlineKeyboardButton('关闭', callback_data='overview:altoff'),
...
def get_overview_schedule_markup():
    keyboard = [[
        InlineKeyboardButton('启用', callback_data='overview:schedon'),
        InlineKeyboardButton('关闭', callback_data='overview:schedoff'),
        InlineKeyboardButton('返回', callback_data='overview:refresh:dlspeed')
    ]]
...
def get_overview_base_markup():
    keyboard = [[
        InlineKeyboardButton('⚙️ 限制速度', callback_data='overview:altspeed'),
        InlineKeyboardButton('⚙️ 计划', callback_data='overview:schedule'),
    ], [
        InlineKeyboardButton('📶 传输信息', callback_data='overview:transferinfo'),
        InlineKeyboardButton('💾 空间', callback_data='overview:freespace'),
...
def actions_markup(torrent_hash):
    keyboard = [
        [
            InlineKeyboardButton('恢复', callback_data='resume:{}'.format(torrent_hash)),
            InlineKeyboardButton('暂停', callback_data='pause:{}'.format(torrent_hash)),
            InlineKeyboardButton('刷新', callback_data='refresh:{}'.format(torrent_hash)),
        ],
        [
            InlineKeyboardButton('强制开始', callback_data='forcestart:{}'.format(torrent_hash)),
            InlineKeyboardButton('取消强制开始', callback_data='unforcestart:{}'.format(torrent_hash)),
        ],
        [
            InlineKeyboardButton('自动种子管理 on/off', callback_data='toggleatm:{}'.format(torrent_hash)),
            InlineKeyboardButton('查看 trackers', callback_data='trackers:{}'.format(torrent_hash))
        ],
        [
            InlineKeyboardButton('删除', callback_data='deletewithfiles:{}'.format(torrent_hash)),
            InlineKeyboardButton('强制校验', callback_data='recheck:{}'.format(torrent_hash)),
            InlineKeyboardButton('减少按钮', callback_data='reduce:{}'.format(torrent_hash)),
        ]
    ]
...
def confirm_delete(torrent_hash):
    return InlineKeyboardMarkup([[
        InlineKeyboardButton('否, 返回', callback_data='manage:{}'.format(torrent_hash)),
